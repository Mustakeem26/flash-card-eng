...
import { playPopSound, playMatchSound, playErrorSound, playSuccessSound, playBackgroundMusic, stopBackgroundMusic } from '@/lib/audio'

const backgroundMusicStarted = ref(false)
...
function handleCardClick(idx: number) {
    ...
    if (!backgroundMusicStarted.value) {
        backgroundMusicStarted.value = true
        playBackgroundMusic()
    }
