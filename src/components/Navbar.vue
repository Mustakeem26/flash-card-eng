            ...
            <motion.div v-if="menuOpen" :initial="{ opacity: 0, scale: 0.95, y: -8 }"
              ...
              <div v-if="showConfirm" class="p-4">
                ...
                <div class="flex gap-2">
                  ...
                  <button @click="confirmLogout"
                    class="flex-1 py-2 text-xs font-bold text-white bg-coral-500 rounded-xl hover:bg-coral-600 transition-colors">
                    Logout
                  </button>
                </div>
              </div>
              ...
              <div v-else class="py-2">
                ...
                <button @click="requestLogout"
                  class="w-full flex items-center gap-3 px-4 py-3 text-sm font-bold text-coral-500 hover:bg-coral-50 transition-colors text-left">
